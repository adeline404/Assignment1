    ...
    return (
        <div>
            ...
            <Box my={4} display="flex" justifyContent="center" alignItems="center">
                <Alert severity="info" style={{ width: '60%', backgroundColor: '#F4FAFF', position: 'relative' }}>
                    <AlertTitle style={{ textAlign: 'left', fontWeight: 'bold' }}>Mission Statement</AlertTitle>
                    To build reliable, scalable software solutions that solve complex problems and improve the quality of life for users.
                </Alert>
            </Box>
            <Link href="/about-me" underline="hover">
